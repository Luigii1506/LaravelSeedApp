<!doctype html>
    ...
    <body>
        <div id="app">
            <div id="wrapper">
                <ul class="navbar-nav-admin navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="scroll-to-top rounded" href="#app" style="display: inline;">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="logoutButton" href="{{ route('logout') }}" class="btn btn-primary" type="button" data-dismiss="modal">Logout</button>
                        </div>
                    </div>
                </div>
            </div>
